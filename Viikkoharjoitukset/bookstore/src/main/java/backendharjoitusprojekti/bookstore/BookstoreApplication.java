...
public class BookstoreApplication {
	...
	public CommandLineRunner bookDemo(BookRepository repository) {
		return (args) -> {
			...
			repository.save(new Book("A Farewell to Arms", "Ernest Hemingway", 1929, "1232323-21", "21,99"));
			repository.save(new Book("Animal Farm", "George Orwell", 1945, "2212343-5", "13,29"));
